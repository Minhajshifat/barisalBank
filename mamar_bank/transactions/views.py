        ...
        if form.is_valid():
            ...
            try:
                ...
                if sender.balance >= amount:
                    ...
                    send_transaction_email(
                        sender.user, amount, "Transaction Details", "sendmail.html"
                    )
                    send_transaction_email(
                        receiver.user, amount, "Transaction Details", "receivemail.html"
                    )

                    messages.success(request, "Amount transferred successfully!")
                else:
                    messages.error(
                        request, "Insufficient balance in the sender account."
                    )
